...
if ($_POST["btonNewsSystem"]) {
    if (empty($_POST["idSubjet"])) {
...
if ($_SESSION["validacion"]) {
    ...
    if (!$subjectDB) {
        ...
        $new = $daoNews->filterBySystem($subject1); //llamo al metodo listar para mostrar los documentos que pertenecen al usuario
    }
}
