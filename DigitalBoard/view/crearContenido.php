...
<html lang="es">
    ...
    <body>
        ...
        <div class="col d-flex flex-wrap" style="margin-right: 0px;margin-top: 150px;margin-bottom: 30px;">
            <h1 style="margin-left: 10px;font-size: 30px;">Crear Contenido Asignatura</h1>
        </div>
        <div style="padding-top: 20px;padding-bottom: 50px;margin-top: 0px;">
            <div class="card shadow flex-row mb-3" style="margin-bottom: 0px;width: 90%;margin-left: 50px;">
                <div class="card-body" style="width: 80%;">
                    <form method="post" action="../controller/insertResource.php" enctype="multipart/form-data">
                        <input type="hidden" name="idSubject" value="<?php echo $_GET['idSubject']; ?>"/>
                        <label for="city" style="width: 100%;"><strong>Carpeta&nbsp;</strong><br></label>
                        <select class="form-control" style="margin-left: 0px;width: 100px;" required="" name="carpeta">
                            <optgroup label="Carpeta Contenido">
